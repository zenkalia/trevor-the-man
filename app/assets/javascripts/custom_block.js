 ...
 * Example of custom block ripped from https://github.com/madebymany/sir-trevor-js/blob/master/examples/javascript/example_block.js
 */
/*
...
SirTrevor.Blocks.Example = (function(){
    ...
    return SirTrevor.Block.extend({
        ...
        editorHTML: function() {
            return "<div class='st-required st-text-block' contenteditable='true'></div>";
        },
